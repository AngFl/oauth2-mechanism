...
public class MobileCodeTokenGranter extends AbstractTokenGranter {
    ...
    protected MobileCodeTokenGranter(AuthenticationManager authenticationManager, AuthorizationServerTokenServices tokenServices,
    ...
    protected OAuth2Authentication getOAuth2Authentication(ClientDetails client, TokenRequest tokenRequest) {
        ...
        parameters.remove("mobileCode");

        Authentication userAuth = new OAuth2MobileCodeAuthentication(mobileNumber, mobileCode);
